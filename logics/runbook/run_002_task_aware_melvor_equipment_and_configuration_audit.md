...
3. Compare equipped items with candidates by stats **and passives**. Reject a raw stat upgrade when it loses task-relevant resistance, defence, reflect, Auto Eat efficiency, or a required passive.
