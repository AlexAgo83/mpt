...
# Tasks
- `task_006_implement_action_aware_equipment_upgrade_plans`

# Notes
- Task `task_006_implement_action_aware_equipment_upgrade_plans` was finished via `logics-manager flow finish task` on 2026-08-16.
